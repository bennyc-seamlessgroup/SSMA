      ...
      <section className="panel dev-only import-data-dev-panel">
        ...
        <ApiDevelopmentTabs sources={[
          ...
          },
          {
            ...
            title: 'User Settings',
            endpoint: `GET /rule-catalog/user-settings?ticker=${encodeURIComponent(ticker)}`,
            source: 'API Gateway',
          ...
          },
          {
            ...
            title: 'Merged Rules',
            endpoint: `GET /rule-catalog + GET /rule-catalog/user-settings?ticker=${encodeURIComponent(ticker)}`,
